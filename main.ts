...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile34`, function (sprite, location) {
    ...
    game.splash("Rings " + rings + "/79", "Red Rings " + red_ring_ + "/2")
    music.play(music.melodyPlayable(music.powerUp), music.PlaybackMode.InBackground)
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile40`, function (sprite, location) {
    ...
    if (seales == 3) {
        ...
        seales = 0
        tiles.setTileAt(tiles.getTileLocation(44, 6), assets.tile`transparency16`)
        tiles.setWallAt(tiles.getTileLocation(44, 6), false)
        tiles.setTileAt(tiles.getTileLocation(50, 7), assets.tile`transparency16`)
        tiles.setWallAt(tiles.getTileLocation(50, 7), false)
        tiles.setTileAt(tiles.getTileLocation(44, 5), assets.tile`transparency16`)
        tiles.setWallAt(tiles.getTileLocation(44, 5), false)
    }
})
